...
doc_5 = Document.create(creator_id: user_1.id, creator_name: user_1.name, title: 'Mending Wall', body: "Something there is that doesn’t love a wall,
...
UserDoc.create(user_id: user_1.id, document_id: doc_3.id)
UserDoc.create(user_id: user_1.id, document_id: doc_4.id)
UserDoc.create(user_id: user_1.id, document_id: doc_5.id)
